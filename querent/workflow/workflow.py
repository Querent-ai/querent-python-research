...
#     class TokensFeader(ChannelCommandInterface):
#         def receive_tokens_in_python(self) -> IngestedTokens:
#             return IngestedTokens(file=None, data="This is the sample data", error=None)
        
#         def receive_in_python(self) -> EventState:
#             return EventState(event_type="Graph", timestamp=1.0, payload="Dummy_event", file=None)
...
#         "tokens_feader": TokensFeader(),
#         "channel": TokensFeader(),
#         },
#         "collectors": [{
#             "id": str(uuid.uuid4()),
#             "name": "Local-config",
