...
class BERTLLM(BaseEngine):
    ...
    def split_into_sentences(text):
        ...
        try:
            ...
            raise Exception(f"An unexpected error occurred while splitting the text: {e}")
    ...
    def combine_subword_entities(self, entities: List[Tuple[str, str]]) -> List[Tuple[str, str]]:
        ...
        try:    
            ...
            raise Exception(f"An unexpected error occurred while combining subword entities: {e}")
    ...
    def _extract_entities_from_chunks(self, token_chunks: List[List[str]]) -> List[Tuple[str, str]]:
            try:    
                ...
                raise Exception(f"An error occurred while extracting entities from chunks: {e}")
