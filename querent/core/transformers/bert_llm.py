    ...
    async def process_tokens(self, data: IngestedTokens):
        ...
        try:
            ...
            if doc_entity_pairs:
                ...
                embedding_triples = semantic_extractor.generate_embeddings(EventState(EventType.ContextualTriples, 1.0, filtered_triples, filename))
                ...
                semantic_triples = semantic_extractor.process_tokens(EventState(EventType.ContextualTriples, 1.0, filtered_triples, filename))
