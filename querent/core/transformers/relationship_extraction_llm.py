...
class RelationExtractor():
    ...
    def process_tokens(self, event_state: EventState):
        try:
            ...
            self.qa_system.initialize_components()
...
def main():
    ...
    try:
        extracted_relationships = relation_extractor.process_tokens(EventState(EventType.CONTEXTUAL_TRIPLES, 1.0, test_triples))
