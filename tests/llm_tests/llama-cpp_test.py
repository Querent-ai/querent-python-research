...
grammar = LlamaGrammar.from_file(file = "/home/nishantg/querent-main/querent/querent/kg/rel_helperfunctions/subject_object_grammar.gbnf")

from llama_cpp import Llama
llm = Llama(model_path="/home/nishantg/querent-main/querent/tests/llama-2-7b-chat.Q5_K_M.gguf")
