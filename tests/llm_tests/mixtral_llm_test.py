...
llm = Llama(model_path="/home/nishantg/Downloads/openhermes-2.5-mistral-7b.Q5_K_M.gguf", chat_format="llama-2")
...
# Context: {context}
# Entity 1: {entity1} and Entity 2: {entity2}
# Query: Using the semantic triple (Subject, Predicate & Object) framework, determine which of the above entity is the subject and which entity is the object based on the above context. Then determine the predicate between these entities along with the subject type, object type & predicate type.
# Answer:""".format(context = context, entity1=entity1, entity2=entity2)
...
Query: First, using the semantic triple framework, determine which of the above entities is the subject and which is the object, and what is the predicate between these entities. Provide your analysis in the form of subject type, object type, and predicate type.
