...
# # collection_name = "pipeline_df9a1386b16b425ab23d1acc40006b9a"
...
# # Connect to Milvus instance (adjust host and port as needed)
# connections.connect("default", host="localhost", port="19530")

# # List all collections
# collection_names = utility.list_collections()

# print("Collections in Milvus instance:")
# for collection_name in collection_names:
#     # Get the collection object using the collection name
#     collection = Collection(name=collection_name)
#     print(collection_name)
#     # Now, you can access the schema fields
#     print("Fields - ", collection.schema.fields)
